...
<Aside title="v2"> In the new design there was no issue using Astro Icons. I believe this is because I started with an empty project. It might be the case that these integrations aren't compatiable sometimes. So check out your other options below!</Aside>
