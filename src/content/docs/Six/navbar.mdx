...
<Aside title="v2"> I am now using Astro Navbar on Beauty of Mathematics. This is the first time that I started with an empty project. Starting completely from scratch made using these components easier to use. Though, I'm probably going back to making my own custom component for more control. </Aside>
